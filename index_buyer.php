            ...
            <nav class="header__nav w-120">
                ...
                <div class="header__nav__content">
                    ...
                    <ul class="header__menu">
                        ...
                        <li class="menu__item">
                            <a href="browse_farmers.php" class="menu__link">Product</a>
                        </li>
                        <li class="menu__item">
                    ...
                    <div class="header__signup">
                        <a href="signup.php" class="btn btn__signup">
                            <i class="fas fa-user-plus"></i> Sign Up
                        </a>
                    </div>
                    <div class="header__signup">
    <a href="logout.php" class="btn btn__signup">
            ...
            <div class="hero__content">
                <div class="hero__text">
                    ...
                    <p class="hero__description">
                        FARMYETU provides farmes, private foresters, and agricultural producers with online self service applications and educational materials.
                    </p>
                    <a href="browse_farmers.php" class="btn btn__hero">İnvest Now</a>
                </div>
                <div class="hero__img">
            ...
            <div class="opportunities__content w-105">
                ...
                <div class="opportunities__body">
                    <div class="opportunity">
                        ...
                        <p class="opportunity__description">Engage, support, and learn from our agricultural community. Explore local
                            expertise, modern techniques, and collaborative opportunities at FARMYETU.
                        </p>
                    </div>
                    ...
                    <div class="opportunity active">
                        ...
                        Boost your business by collaborating with skilled farmers. Explore a diverse range of farming
                        expertise on FARMYETU. Discover opportunities to grow and innovate together for a flourishing
                    ...
                    <div class="opportunity">
                        ...
                        <p class="opportunity__description">
                        Empower communities through sustainable farming support initiatives driving positive change in agriculture.
                        Discover opportunities to invest in impactful projects on FARMYETU.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="invest  w-105">
            <div class="invest__content">
                <div class="invest__head">
                    ...
                    <p class="invest__description">Experience the future of agriculture by investing in a farmer's success. Grow your
                        portfolio while supporting sustainable farming practices. Join us in empowering farmers and reaping the rewards
                        of agricultural innovation. Invest in a farmer's journey today for a fruitful tomorrow.</p>
                </div>
                <div class="invest__body">
                    <div class="invest__item">
                        ...
                        <div class="invest__item__footer">
                            <a href="browse_farmers.php" class="btn btn__invest">Browse Farm</a>
                        </div>
                    </div>
                    <div class="invest__item">
                        <div class="invest__item__head">
            ...
            <div class="works__content">
                <div class="works__head">
                    ...
                    <p class="works__description">
                        Take your pick from the supply chain and participate in agribusiness projects that are backed up not only by FARMYETU, but also by the best land, family heritage, innovation and overall superior expertise.
                    </p>
                </div>
        ...
        <section class="testimonials">
            <div class="testimonials__content">
                <div class="testimonials__head w-105">
                    ...
                    <h2 class="testimonials__title">What investors like you are saying about FARMYETU</h2>
                </div>
                    ...
                    <div class="testimonials__list">
                        <div class="testimonial">
                            ...
                            <p class="testimonial__description">
                                “ FarmYetu exceeded expectations—transformative agricultural solutions empowering farmers and investors alike, a game-changer in the industry! “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ Reliable, innovative, and ethical—FarmYetu's commitment to farmers and investors is exemplary, a trusted partner in agribusiness. “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ Remarkable impact! FarmYetu's dedication to revolutionizing agriculture inspires, connecting investors and farmers for mutual prosperity and growth. “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ Unmatched excellence! FarmYetu's cutting-edge approach fosters agricultural advancement, bridging opportunities between investors and farmers seamlessly. “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ Exceptional service! FarmYetu's transformative solutions benefit both farmers and investors, setting a new standard in agribusiness initiatives. “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ FarmYetu—stellar support for farmers and investors, pioneering innovation, and fostering agricultural prosperity through revolutionary solutions “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ FarmYetu shines brightly! Their pioneering efforts unite investors and farmers, offering a visionary platform for sustainable agricultural growth. “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ Outstanding commitment! FarmYetu's dedication to farmers' success and investor satisfaction sets a precedent in the agricultural investment sphere. “
                            </p>
                        </div>
                        <div class="testimonial">
                            <div class="testimonial__profile">
                            ...
                            <p class="testimonial__description">
                                “ FarmYetu's brilliance in connecting farmers and investors is unparalleled, driving sustainable agricultural growth with integrity and innovation.  “
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="farm-invest w-105">
            <h2 class="farm-invest__title">The future of <span>Farm Investing</span> is FARMYETU</h2>
            <a href="browse_farmers.php" class="btn btn__farm--invest">Invest Now</a>
        ...
        <footer class="footer">
            <div class="footer__body w-105">
                ...
                <div class="footer__contact">
                    <h5 class="footer__contact__title">Blog FARMYETU</h5>
                    <span>Write email to us</span>
                    <a href="mailto:info@farmyetu.com" class="email">info@farmyetu.com</a>
            ...
            <div class="footer__bottom">
                <div class="footer__bottom__content w-105">
                    ...
                    <p class="footer_copyright">
                        © Copyright 2023. FARMYETU Capital Ltd.
                    </p>
                </div>
